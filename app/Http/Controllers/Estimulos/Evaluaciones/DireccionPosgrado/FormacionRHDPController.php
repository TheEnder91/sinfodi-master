...
class FormacionRHDPController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-posgrado-formacion-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionPosgrado.formacion.index', compact('criterios'));
    }
