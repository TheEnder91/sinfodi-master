...
class InvestigacionDPTController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-proyectos-investigacion-index',
        'indexB' => 'estimulo-evaluaciones-proyectos-investigacionB-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionProyTec.investigacion.index', [
            'criterios' => $criterios,
        ]);
    }
        ...
        $query = DB::connection('sinfodiDB')->table('sinfodidb.sinfodi_lfc_personas')
                    ...
                    ->join('productivo_sinfodi.sinfodi_evaluados', function($join){
                        $join->on('productivo_sinfodi.sinfodi_evaluados.clave', '=', 'sinfodidb.sinfodi_lfc_personas.lfc_clave_persona')
                             ->where('productivo_sinfodi.sinfodi_evaluados.puesto', '=', 'Direccion_Proyectos_Tecno');
                    })
