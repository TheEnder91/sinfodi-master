...
class PosgradoDPTController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-proyectos-posgrado-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionProyTec.posgrado.index', [
            'criterios' => $criterios,
        ]);
    }
