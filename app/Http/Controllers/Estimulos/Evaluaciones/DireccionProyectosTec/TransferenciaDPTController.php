...
class TransferenciaDPTController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-proyectos-transferencia-index',
        'indexB' => 'estimulo-evaluaciones-proyectos-transferenciaB-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionProyTec.transferencia.index', compact('criterios'));
    }
    ...
    public function indexB()
    {
        ...
        return view('estimulos.evaluaciones.direccionProyTec.transferenciaB.index', compact('criterios'));
    }
