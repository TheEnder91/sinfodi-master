...
class FormacionRHDSTController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-servicios-formacion-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionServTec.formacion.index', compact('criterios'));
    }
