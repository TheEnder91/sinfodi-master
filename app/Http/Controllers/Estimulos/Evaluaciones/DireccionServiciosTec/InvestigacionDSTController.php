...
class InvestigacionDSTController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionServTec.investigacion.index', [
            'criterios' => $criterios,
        ]);
    }
        ...
        $query = DB::connection('sinfodiDB')->table('sinfodidb.sinfodi_lfc_personas')
                    ...
                    ->join('productivo_sinfodi.sinfodi_evaluados', function($join){
                        $join->on('productivo_sinfodi.sinfodi_evaluados.clave', '=', 'sinfodidb.sinfodi_lfc_personas.lfc_clave_persona')
                             ->where('productivo_sinfodi.sinfodi_evaluados.puesto', '=', 'Direccion_Servicios_Tecno');
                    })
    ...
    public function indexB(){
        return view('estimulos.evaluaciones.direccionServTec.investigacionB.index');
    }
}
