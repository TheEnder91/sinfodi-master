...
class FormacionRHDAController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-administracion-formacion-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionAdministracion.formacion.index', compact('criterios'));
    }
