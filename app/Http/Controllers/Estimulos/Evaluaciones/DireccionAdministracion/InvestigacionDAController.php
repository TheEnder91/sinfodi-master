...
class InvestigacionDAController extends Controller
{
    ...
    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-administracion-investigacion-index',
        'indexB' => 'estimulo-evaluaciones-administracion-investigacionB-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionAdministracion.investigacion.index', [
            'criterios' => $criterios,
        ]);
    }
