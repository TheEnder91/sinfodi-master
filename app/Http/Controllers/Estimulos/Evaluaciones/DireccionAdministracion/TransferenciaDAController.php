...
class TransferenciaDAController extends Controller
{
    ...
    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-administracion-transferencia-index',
        'indexB' => 'estimulo-evaluaciones-administracion-transferenciaB-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionAdministracion.transferencia.index', compact('criterios'));
    }
