...
class PosgradoDAController extends Controller
{
    use SingleResponse;

    const PERMISSIONS = [
        'index' => 'estimulo-evaluaciones-administracion-posgrado-index',
    ];
    ...
    public function index()
    {
        ...
        return view('estimulos.evaluaciones.direccionAdministracion.posgrado.index', [
            'criterios' => $criterios,
        ]);
    }
