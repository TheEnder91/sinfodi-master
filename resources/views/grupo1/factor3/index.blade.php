...
@section('content')
    @component('components.card')
        ...
        <div class="container" style="border: solid 1px #000; border-radius: 5px; padding-top: 10px; padding-bottom: 10px; padding-left: 10px; padding-right: 10px; font-weight: bold;">
            ...
            ANEXO 1, numeral 2, página 16; criterio de la Dirección General de no evaluarse y acordado por el Comité de Estímulos conforme al oficio
            SDCH-056-2022 de fecha 13 de junio 2022.
        </div>
    @endcomponent
@endsection
