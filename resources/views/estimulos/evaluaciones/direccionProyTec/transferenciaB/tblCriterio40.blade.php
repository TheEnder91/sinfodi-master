...
<script>
    ...
    function verTablaCriterio40(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosProyectosCriterio40){
                var datosProyectosCriterio40 = datosProyectosCriterio40.response;
                // console.log(datosProyectosCriterio40);
                var row = "";
                for(var i = 0; i < datosProyectosCriterio40.length; i++){
                    var dataProyectosCriteri40 = datosProyectosCriterio40[i];
