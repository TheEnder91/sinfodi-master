...
@include('estimulos.evaluaciones.direccionProyTec.posgrado.modalEvidenciasCriterio5')
            ...
            ok: function(datosCritero5){
                ...
                if(datosCriterio5.length > 0){
                    for(var i = 0; i < datosCriterio5.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/posgrado/searchUsernamePosgrado/" + dataCriterio5.numero_personal,
                            type: 'GET',
                            dataType: 'json',
                    ...
                    ok: function(puntosCriterio5){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                var evidencias = claveData.evidencias.substring(claveData.evidenciaslastIndexOf("/") + 1);
