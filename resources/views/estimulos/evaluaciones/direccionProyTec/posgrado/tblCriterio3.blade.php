...
@include('estimulos.evaluaciones.direccionProyTec.posgrado.modalEvidenciasCriterio3')
            ...
            ok: function(datosCritero3){
                ...
                if(datosCriterio3.length > 0){
                    for(var i = 0; i < datosCriterio3.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/posgrado/searchUsernamePosgrado/" + dataCriterio3.numero_personal,
                            type: 'GET',
                            dataType: 'json',
