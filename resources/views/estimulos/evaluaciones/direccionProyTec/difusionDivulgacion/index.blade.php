...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Evaluacion a la dirección de proyectos tecnologicos->Difusión y Divulgación</li>
    </ol>
@endsection

@section('content')
    @component('components.card')
        @slot('title_card', 'Evaluación a la dirección de proyectos tecnologicos->Difusión y Divulgación')
        <div class="row">
            <div class="col-3">
        ...
        <div class="table-responsive">
            <table id="tblCriterio1" class="table table-bordered table-striped">
                <caption style="font-size:13px;">Listado de evaluación Dirección de proyectos tecnologicos->Difusión y Divulgación y sus respectivos puntos.</caption>
                <thead>
                    <tr class="text-center">
                        ...
                        @if (Auth::user()->hasPermissionTo("estimulo-evaluaciones-proyectos-difusiondivulgacion-index"))
        ...
        @include('estimulos.evaluaciones.direccionProyTec.difusionDivulgacion.modalEvidenciasCriterio1')
    @endcomponent
@endsection
...
@section('scripts')
    <script>
        ...
        function obtenerCriterio1(year){
            ...
            // Codigo de prueba...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/searchDifDIv/" + año,
                type: 'GET',
                dataType: 'json',
        ...
        function verTablaCriterio1(año, criterio){
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/datosDifDiv/" + año + "/" + criterio,
                type: 'GET',
                dataType: 'json',
        ...
        function verEvidenciasCriterio1(year, clave){
            ...
            var objetivo = 1;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/searchEvidenciasDifDiv/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
                ok: function(dataEvidenciasCriterio1){
                    $('#modalEvidenciasCriterio1').modal({backdrop: 'static', keyboard: false});
                    consultarDatos({
                        action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/puntosDifDiv/" + criterio + "/" + objetivo,
                        type: 'GET',
                        dataType: 'json',
                        ok: function(puntosCriterio1){
                            ...
                            consultarDatos({
                                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/getEvidenciasDifDiv/"+clave+"/"+year+"/"+criterio,
                                type: 'GET',
                                dataType: 'json',
        ...
        function actualizarEvidenciasCriterio1(){
            ...
            var objetivo = 1;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/obtenerEvidenciasDifDiv/" + clave + "/" + year + "/" + criterio,
                type: 'GET',
                dataType: 'json',
                        ...
                        ok: function(puntosCriterio1){
                            ...
                            if(cantidadEvidencias == 0){
                                ...
                                if(existe == 0){
                                    $.ajax({
                                        type: 'POST',
                                        url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/savePuntos",
                                        data: {
                                            token: $('#txtTokenRepo').val(),
                                            clave: clave,
                                        ...
                                        success: function(data){
                                            consultarDatos({
                                                ...
                                                ok: function(getEvidenciasCriterio1){
                                                    ...
                                                    $.ajax({
                                                        type: 'PUT',
                                                        url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/updateDatosPuntos",
                                                        data: {
                                                            token: $('#txtTokenRepo').val(),
                                                            clave: clave,
                                                            id_criterio: criterio,
                                    ...
                                    $.ajax({
                                        type: 'PUT',
                                        url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/DifDiv/updateDatosDifDiv",
                                        data: {
                                            token: $('#txtTokenRepo').val(),
                                            clave: clave,
                                            evidencias: serieEvidencias,
