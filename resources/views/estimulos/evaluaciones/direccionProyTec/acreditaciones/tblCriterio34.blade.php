...
@include('estimulos.evaluaciones.direccionProyTec.acreditaciones.modalEvidenciasCriterio34')
            ...
            ok: function(datosCritero34 ){
                ...
                if(datosCriterio34.length > 0){
                    ...
                    for(var i = 0; i < datosCriterio34.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/posgrado/searchUsernamePosgrado/" + dataCriterio34.numero_personal,
                            type: 'GET',
                            dataType: 'json',
