...
@include('estimulos.evaluaciones.direccionProyTec.acreditaciones.modalEvidenciasCriterio33')
<script>
    function obtenerCriterio33(year, criterio){
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/searchAcreditaciones/" + year + "/" + criterio,
            type: 'GET',
            dataType: 'json',
            ok: function(datosCritero33 ){
                ...
                if(datosCriterio33.length > 0){
                    ...
                    for(var i = 0; i < datosCriterio33.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/posgrado/searchUsernamePosgrado/" + dataCriterio33.numero_personal,
                            type: 'GET',
                            dataType: 'json',
    ...
    function verTablaCriterio33(year, criterio){
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/datosAcreditaciones/" + year + "/" + criterio,
            type: 'GET',
            dataType: 'json',
    ...
    function verEvidenciasCriterio33(year, clave){
        ...
        var objetivo = 8;
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/searchEvidencias/" + year + "/" + clave + "/" + criterio,
            type: 'GET',
            dataType: 'json',
            ok: function(dataEvidenciasCriterio33){
                ...
                consultarDatos({
                    action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/puntos/" + criterio + "/" + objetivo,
                    type: 'GET',
                    dataType: 'json',
                    ok: function(puntosCriterio33){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/getEvidenciasAcreditaciones/"+clave+"/"+year+"/"+criterio,
                            type: 'GET',
                            dataType: 'json',
    ...
    function actualizarEvidenciasCriterio33(){
        ...
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/obtenerEvidencias/" + clave + "/" + year + "/" + criterio,
            type: 'GET',
            dataType: 'json',
                    ...
                    ok: function(puntosCriterio33){
                        ...
                        if(cantidadEvidencias == 0){
                            ...
                            if(existe == 0){
                                $.ajax({
                                    type: 'POST',
                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/savePuntos",
                                    data: {
                                        token: $('#txtTokenRepo').val(),
                                        clave: clave,
                                    ...
                                    success: function(data){
                                        consultarDatos({
                                            ...
                                            ok: function(getEvidenciasCriterio33){
                                                ...
                                                $.ajax({
                                                    type: 'PUT',
                                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/updateDatosPuntos",
                                                    data: {
                                                        token: $('#txtTokenRepo').val(),
                                                        clave: clave,
                                                        id_criterio: criterio,
                                ...
                                $.ajax({
                                    type: 'PUT',
                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/acreditaciones/updateDatos",
                                    data: {
                                        token: $('#txtTokenRepo').val(),
                                        clave: clave,
                                        evidencias: serieEvidencias,
