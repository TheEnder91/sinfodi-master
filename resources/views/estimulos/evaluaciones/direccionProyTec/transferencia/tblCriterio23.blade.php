...
@include('estimulos.evaluaciones.direccionProyTec.transferencia.modalEvidenciasCriterio23')
...
<script>
    ...
    function verTablaCriterio23(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosProyectosCriterio23){
                // console.log(datosProyectosCriterio23);
                var datosProyectosCriterio23 = datosProyectosCriterio23.response;
                var row = "";
                for(var i = 0; i < datosProyectosCriterio23.length; i++){
                    var dataProyectosCriterio23 = datosProyectosCriterio23[i];
                    // console.log(dataProyectosCriterio23);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-proyectos-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataProyectosCriterio23.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio23.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataProyectosCriterio23.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataProyectosCriterio23.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataProyectosCriterio23.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio23.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio23(' + dataProyectosCriterio23.year + ', ' + dataProyectosCriterio23.clave + ', ' + 23 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
