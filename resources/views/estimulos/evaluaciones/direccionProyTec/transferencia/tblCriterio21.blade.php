...
@include('estimulos.evaluaciones.direccionProyTec.transferencia.modalEvidenciasCriterio21')
...
<script>
    ...
    function verTablaCriterio21(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosProyectosCriterio21){
                // console.log(datosProyectosCriterio21);
                var datosProyectosCriterio21 = datosProyectosCriterio21.response;
                var row = "";
                for(var i = 0; i < datosProyectosCriterio21.length; i++){
                    var dataProyectosCriterio21 = datosProyectosCriterio21[i];
                    // console.log(dataProyectosCriterio21);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-proyectos-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataProyectosCriterio21.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio21.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataProyectosCriterio21.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio21.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio21.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio21.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio21(' + dataProyectosCriterio21.year + ', ' + dataProyectosCriterio21.clave + ', ' + 21 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
