...
@include('estimulos.evaluaciones.direccionProyTec.transferencia.modalEvidenciasCriterio20')
...
<script>
    ...
    function verTablaCriterio20(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosProyectosCriterio20){
                // console.log(datosProyectosCriterio20);
                var datosProyectosCriterio20 = datosProyectosCriterio20.response;
                var row = "";
                for(var i = 0; i < datosProyectosCriterio20.length; i++){
                    var dataProyectosCriterio20 = datosProyectosCriterio20[i];
                    // console.log(dataProyectosCriterio20);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-proyectos-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataProyectosCriterio20.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio20.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataProyectosCriterio20.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio20.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio20.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio20.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio20(' + dataProyectosCriterio20.year + ', ' + dataProyectosCriterio20.clave + ', ' + 20 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
