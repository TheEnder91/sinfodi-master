...
@include('estimulos.evaluaciones.direccionProyTec.transferencia.modalEvidenciasCriterio18')
...
<script>
    ...
    function verTablaCriterio18(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosProyectosCriterio18){
                // console.log(datosProyectosCriterio18);
                var datosProyectosCriterio18 = datosProyectosCriterio18.response;
                var row = "";
                for(var i = 0; i < datosProyectosCriterio18.length; i++){
                    var dataProyectosCriterio18 = datosProyectosCriterio18[i];
                    // console.log(dataProyectosCriterio18);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-proyectos-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataProyectosCriterio18.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio18.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataProyectosCriterio18.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio18.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio18.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataProyectosCriterio18.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio18(' + dataProyectosCriterio18.year + ', ' + dataProyectosCriterio18.clave + ', ' + 18 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
