...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Evaluaciones a la dirección de proyectos tecnologicos->Sostentabilidad economica</li>
    </ol>
@endsection

@section('content')
    @component('components.card')
        @slot('title_card', 'Evaluación a la dirección de proyectos tecnologicos->Sostentabilidad economica')
        <div class="row">
            <div class="col-3">
...
@section('scripts')
    <script>
        ...
        function obtenerCriterio14(year){
            ...
            var criterio = 14;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/sostentabilidad/searchSostentabilidad/" + año,
                type: 'GET',
                dataType: 'json',
                ok: function(datosCritero14){
                    ...
                    if(datosCriterio14.length > 0){
                        for(var i = 0; i < datosCriterio14.length; i++){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/sostentabilidad/saveDatosSostentabilidad",
                                data: {
        ...
        function verTablaCriterio14(year, criterio){
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/sostentabilidad/datosSostentabilidad/" + year + "/" + criterio,
                type: 'GET',
                dataType: 'json',
                ok: function(datosProyectosCriterio14){
                    // console.log(datosProyectosCriterio14);
                    var datosProyectosCriterio14 = datosProyectosCriterio14.response;
                    var row = "";
                    for(var i = 0; i < datosProyectosCriterio14.length; i++){
                        var dataProyectosCriterio14 = datosProyectosCriterio14[i];
                        // console.log(dataProyectosCriterio14);
                        var authUser = '<?= Auth::user()->usuario ?>';
                        var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-proyectos-sostentabilidad-index") ?>';
                        // console.log(permissions);
                        if(dataProyectosCriterio14.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="8%" style="font-size:12px;">' + dataProyectosCriterio14.clave + '</td>';
                                row += '<td width="77%" style="font-size:12px;">' + dataProyectosCriterio14.nombre.toUpperCase() + "</td>";
                                row += '<td class="text-center" width="5%" style="font-size:12px;">' + dataProyectosCriterio14.total_puntos + '</td>';
                                row += '<td class="text-center" width="5%" style="font-size:12px;">' + dataProyectosCriterio14.year + '</td>';
                                row += '<td class="text-center" width="5%" style="font-size:12px;"><a href="javascript:verDetalleCriterio14(' + dataProyectosCriterio14.year + ', ' + dataProyectosCriterio14.clave + ')"><i class="fa fa-search"></i></a></td>';
                                row += "</tr>";
                        }
                    }
        ...
        function verDetalleCriterio14(year, clave){
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostentabilidad/calculosSostentabilidad/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostentabilidad/detallesProyectos/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostentabilidad/detallesServicios/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
            ...
            // Detalles cursos...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostentabilidad/detallesCursos/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
