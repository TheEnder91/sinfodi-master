...
@include('estimulos.evaluaciones.direccionProyTec.investigacion.modalEvidenciasCriterio11')
            ...
            ok: function(datosCienciaCriterio11){
                ...
                for(var i = 0; i < datosCienciaCriterio11.length; i++){
                    ...
                    if(dataCienciaCriterio11.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio11.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio11.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio11.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio11.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio11.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio11(' + dataCienciaCriterio11.year + ', ' + dataCienciaCriterio11.clave + ', ' + 11 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
