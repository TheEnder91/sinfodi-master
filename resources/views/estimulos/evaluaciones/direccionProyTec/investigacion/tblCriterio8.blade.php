...
@include('estimulos.evaluaciones.direccionProyTec.investigacion.modalEvidenciasCriterio8')
            ...
            ok: function(datosCienciaCriterio8){
                ...
                for(var i = 0; i < datosCienciaCriterio8.length; i++){
                    ...
                    if(dataCienciaCriterio8.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio8.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio8.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio8.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio8.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio8.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio8(' + dataCienciaCriterio8.year + ', ' + dataCienciaCriterio8.clave + ', ' + 8 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
