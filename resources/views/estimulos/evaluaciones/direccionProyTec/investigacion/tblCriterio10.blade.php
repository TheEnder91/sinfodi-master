...
@include('estimulos.evaluaciones.direccionProyTec.investigacion.modalEvidenciasCriterio10')
            ...
            ok: function(datosCienciaCriterio10){
                ...
                for(var i = 0; i < datosCienciaCriterio10.length; i++){
                    ...
                    if(dataCienciaCriterio10.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio10.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio10.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio10.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio10.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio10.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio10(' + dataCienciaCriterio10.year + ', ' + dataCienciaCriterio10.clave + ', ' + 10 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
