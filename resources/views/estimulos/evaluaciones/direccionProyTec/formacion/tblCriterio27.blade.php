...
@include('estimulos.evaluaciones.direccionProyTec.formacion.modalEvidenciasCriterio27')
            ...
            ok: function(datosCritero27){
                ...
                if(datosCriterio27.length > 0){
                    for(var i = 0; i < datosCriterio27.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/formacionRH/searchUsernameFormacionRH/" + dataCriterio27.numero_personal,
                            type: 'GET',
                            dataType: 'json',
            ...
            ok: function(datosCienciaCriterio27){
                ...
                for(var i = 0; i < datosCienciaCriterio27.length; i++){
                    ...
                    if(dataCienciaCriterio27.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio27.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio27.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio27.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio27.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio27.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio27(' + dataCienciaCriterio27.year + ', ' + dataCienciaCriterio27.clave + ', ' + 27 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
                    ...
                    ok: function(puntosCriterio27){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio27" name="evidenciasCriterio27[]" id="evidenciasCriterio27'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio27('+puntos+');"> ' + claveEvidencias + ' -> 100%</b>';
                                row += '</div>';
                            }
                        }
