...
@include('estimulos.evaluaciones.direccionProyTec.formacion.modalEvidenciasCriterio31')
            ...
            ok: function(datosCritero31){
                ...
                if(datosCriterio31.length > 0){
                    for(var i = 0; i < datosCriterio31.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/formacionRH/searchUsernameFormacionRH/" + dataCriterio31.numero_personal,
                            type: 'GET',
                            dataType: 'json',
                    ...
                    ok: function(puntosCriterio31){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio31" name="evidenciasCriterio31[]" id="evidenciasCriterio31'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio31('+puntos+');"> ' + claveEvidencias + ' -> 100%</b>';
                                row += '</div>';
                            }
                        }
