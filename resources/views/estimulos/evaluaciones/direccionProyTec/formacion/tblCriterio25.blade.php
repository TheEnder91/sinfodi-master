...
@include('estimulos.evaluaciones.direccionProyTec.formacion.modalEvidenciasCriterio25')
            ...
            ok: function(datosCritero25){
                ...
                if(datosCriterio25.length > 0){
                    for(var i = 0; i < datosCriterio25.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/formacionRH/searchUsernameFormacionRH/" + dataCriterio25.numero_personal,
                            type: 'GET',
                            dataType: 'json',
                    ...
                    ok: function(puntosCriterio25){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio25" name="evidenciasCriterio25[]" id="evidenciasCriterio25'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio25('+puntos+');"> ' + claveEvidencias + ' -> 100%</b>';
                                row += '</div>';
                            }
                        }
