                    ...
                    ok: function(puntosCriterio24){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio24" name="evidenciasCriterio24[]" id="evidenciasCriterio24'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio24('+puntos+');"> ' + claveEvidencias + ' -> 100%</b>';
                                row += '</div>';
                            }
                        }
