...
@include('estimulos.evaluaciones.direccionProyTec.formacion.modalEvidenciasCriterio30')
            ...
            ok: function(datosCritero30){
                ...
                if(datosCriterio30.length > 0){
                    for(var i = 0; i < datosCriterio30.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/formacionRH/searchUsernameFormacionRH/" + dataCriterio30.numero_personal,
                            type: 'GET',
                            dataType: 'json',
                    ...
                    ok: function(puntosCriterio30){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio30" name="evidenciasCriterio30[]" id="evidenciasCriterio30'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio30('+puntos+');"> ' + claveEvidencias + ' -> 100%</b>';
                                row += '</div>';
                            }
                        }
