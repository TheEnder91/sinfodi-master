...
@include('estimulos.evaluaciones.direccionProyTec.formacion.modalEvidenciasCriterio28')
            ...
            ok: function(datosCritero28){
                ...
                if(datosCriterio28.length > 0){
                    for(var i = 0; i < datosCriterio28.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionProyTec/formacionRH/searchUsernameFormacionRH/" + dataCriterio28.numero_personal,
                            type: 'GET',
                            dataType: 'json',
                    ...
                    ok: function(puntosCriterio28){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio28" name="evidenciasCriterio28[]" id="evidenciasCriterio28'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio28('+puntos+');"> ' + claveEvidencias + ' -> 100%</b>';
                                row += '</div>';
                            }
                        }
