...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ \App\Traits\Principal::getUrlToken('/estimulos/evaluaciones/responsabilidades/directores/listDirectores') }}">Evaluacion a directores</a></li>
        <li class="breadcrumb-item active">Historial de evaluaciones a directores</li>
    </ol>
@endsection

@section('content')
    @component('components.card')
        @slot('title_card', 'Historial de evaluaciones a directores')
        <div class="table-responsive" id="central">
            <table id="tblHistorial" class="table table-bordered table-striped">
                <caption>Listado de evaluacion a directores.</caption>
                <thead>
                ...
                <tbody>
                    @foreach ($directores as $item)
                        @if (Auth::user()->hasPermissionTo('estimulo-evaluaciones-directores-index') || $item->username == Auth::user()->usuario)
                            <tr>
