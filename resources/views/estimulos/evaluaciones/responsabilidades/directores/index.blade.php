...
@section('content')
    @component('components.card')
        ...
        <section class="text-right">
            <a href="{{ \App\Traits\Principal::getUrlToken('/estimulos/evaluaciones/responsabilidades/directores/historialDirectores') }}" class="btn btn-primary" role="button" aria-disabled="true">
                            ...
                            <tr>
                                ...
                                @if (Auth::user()->hasPermissionTo('estimulo-evaluaciones-directores-index'))
                                    <td class="text-center" width="10%">
                                        <a href="javascript:guardarDirector('{{ $item->clave }}', '{{ $item->nombre }}', '{{ $item->direccion }}', '{{ $item->responsabilidad }}', {{ $item->puntos }}, {{ $item->year }}, '{{ $item->username }}')"><i class="far fa-save fa-lg"></i></a>
                                    </td>
                                @endif
                            </tr>
                        @endif
