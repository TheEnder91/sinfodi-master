    ...
    @component('components.card')
        ...
        <div class="table-responsive">
            <table id="tblCriterio32" class="table table-bordered table-striped" style="font-size:13px;">
                <caption style="font-size:13px;">Puntos por las personas que participan en algun grupo institucional</caption>
                <thead>
...
@section('scripts')
    <script>
                ...
                ok: function(datosGeneralCriterio32){
                    ...
                    for(var i = 0; i < datosGeneralCriterio32.length; i++){
                        ...
                        if(dataGeneralCriterio32.username == authUser || permissions == 1){
                                ...
                                row += '<td width="72%" style="font-size:12px;">' + dataGeneralCriterio32.nombre.toUpperCase() + "</td>";
                                ...
                                row += '<td class="text-center" width="5%" style="font-size:12px;"><a href="javascript:verDetalleCriterio32(' + dataGeneralCriterio32.year + ', ' + dataGeneralCriterio32.clave + ')"><i class="fa fa-search"></i></a></td>';
                                row += "</tr>";
                        }
                    }
        ...
        function verDetalleCriterio32(year, clave){
            ...
            var puntos = 10;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionGeneral/colaboracion/getComiteColaboracion/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
