...
@include('estimulos.evaluaciones.direcionGeneral.investigacion.modalEvidenciasCriterio9')
...
<script>
        ...
        consultarDatos({
            ...
            ok: function(datosCritero9){
                ...
                consultarDatos({
                    ...
                    type: 'GET',
                    dataType: 'json',
                    ok: function(datosGeneralCriterio9){
                        // console.log(datosGeneralCriterio9);
                        var datosGeneralCriterio9 = datosGeneralCriterio9.response;
                        var row = "";
                        for(var i = 0; i < datosGeneralCriterio9.length; i++){
                            var dataGeneralCriterio9 = datosGeneralCriterio9[i];
                            // console.log(dataGeneralCriterio9);
                            var authUser = '<?= Auth::user()->usuario ?>';
                            var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-general-investigacion-index") ?>';
                            // console.log(permissions);
                            if(dataGeneralCriterio9.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio9.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio9.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio9.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio9.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio9.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio9(' + dataGeneralCriterio9.year + ', ' + dataGeneralCriterio9.clave + ', ' + 9 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio9){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio9(clave, year, 9);
                            }else{
    ...
    function actualizarDatosGeneralCriterio8(clave, year, criterio){
