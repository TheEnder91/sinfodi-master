            ...
            ok: function(datosGeneralCriterio9){
                ...
                for(var i = 0; i < datosGeneralCriterio9.length; i++){
                    ...
                    if(dataGeneralCriterio9.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio9.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio9.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio9.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio9.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio9.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio9(' + dataGeneralCriterio9.year + ', ' + dataGeneralCriterio9.clave + ', ' + 9 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
