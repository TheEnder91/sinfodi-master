...
<script>
                    ...
                    ok: function(datosGeneralCriterio10){
                        ...
                        for(var i = 0; i < datosGeneralCriterio10.length; i++){
                            ...
                            if(dataGeneralCriterio10.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio10.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio10.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio10.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio10.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio10.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio10(' + dataGeneralCriterio10.year + ', ' + dataGeneralCriterio10.clave + ', ' + 10 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio10){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio10(clave, year, 10);
                            }else{
    ...
    function actualizarDatosGeneralCriterio10(clave, year, criterio){
