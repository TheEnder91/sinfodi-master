...
<script>
                    ...
                    ok: function(datosGeneralCriterio11){
                        ...
                        for(var i = 0; i < datosGeneralCriterio11.length; i++){
                            ...
                            if(dataGeneralCriterio11.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio11.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio11.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio11.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio11.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio11.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio11(' + dataGeneralCriterio11.year + ', ' + dataGeneralCriterio11.clave + ', ' + 11 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio11){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio11(clave, year, 11);
                            }else{
    ...
    function actualizarDatosGeneralCriterio11(clave, year, criterio){
