...
<script>
                    ...
                    ok: function(datosGeneralCriterio13){
                        ...
                        for(var i = 0; i < datosGeneralCriterio13.length; i++){
                            ...
                            if(dataGeneralCriterio13.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio13.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio13.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio13.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio13.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio13.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio13(' + dataGeneralCriterio13.year + ', ' + dataGeneralCriterio13.clave + ', ' + 13 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio13){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio13(clave, year, 13);
                            }else{
    ...
    function actualizarDatosGeneralCriterio13(clave, year, criterio){
