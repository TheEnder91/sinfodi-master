            ...
            ok: function(datosGeneralCriterio4){
                ...
                for(var i = 0; i < datosGeneralCriterio4.length; i++){
                    ...
                    if(dataGeneralCriterio4.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio4.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio4.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio4.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio4.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio4.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio4(' + dataGeneralCriterio4.year + ', ' + dataGeneralCriterio4.clave + ', ' + criterio +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
