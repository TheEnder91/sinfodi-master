                    ...
                    ok: function(datosGeneralCriterio3){
                        ...
                        for(var i = 0; i < datosGeneralCriterio3.length; i++){
                            ...
                            if(dataGeneralCriterio3.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio3.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio3.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio3.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio3.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio3.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio3(' + dataGeneralCriterio3.year + ', ' + dataGeneralCriterio3.clave + ', ' + 3 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
