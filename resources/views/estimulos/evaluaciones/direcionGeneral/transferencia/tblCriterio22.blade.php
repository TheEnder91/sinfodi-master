...
<script>
                    ...
                    ok: function(datosGeneralCriterio22){
                        ...
                        for(var i = 0; i < datosGeneralCriterio22.length; i++){
                            ...
                            if(dataGeneralCriterio22.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio22.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio22.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio22.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio22.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio22.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio22(' + dataGeneralCriterio22.year + ', ' + dataGeneralCriterio22.clave + ', ' + 22 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio22){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio22(clave, year, 22);
    ...
    function actualizarDatosGeneralCriterio22(clave, year, criterio){
