...
@include('estimulos.evaluaciones.direcionGeneral.transferencia.modalEvidenciasCriterio22')
...
<script>
    ...
    function verTablaCriterio22(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosGeneralCriterio22){
                // console.log(datosGeneralCriterio22);
                var datosGeneralCriterio22 = datosGeneralCriterio22.response;
                var row = "";
                for(var i = 0; i < datosGeneralCriterio22.length; i++){
                    var dataGeneralCriterio22 = datosGeneralCriterio22[i];
                    // console.log(dataGeneralCriterio22);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-general-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataGeneralCriterio22.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio22.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio22.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio22.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio22.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio22.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio22(' + dataGeneralCriterio22.year + ', ' + dataGeneralCriterio22.clave + ', ' + criterio +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
