...
<script>
                    ...
                    ok: function(datosGeneralCriterio15){
                        ...
                        for(var i = 0; i < datosGeneralCriterio15.length; i++){
                            ...
                            if(dataGeneralCriterio15.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio15.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio15.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio15.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio15.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio15.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio15(' + dataGeneralCriterio15.year + ', ' + dataGeneralCriterio15.clave + ', ' + 15 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio15){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio15(clave, year, 15);
    ...
    function actualizarDatosGeneralCriterio15(clave, year, criterio){
