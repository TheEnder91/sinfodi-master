            ...
            ok: function(datosGeneralCriterio17){
                ...
                for(var i = 0; i < datosGeneralCriterio17.length; i++){
                    ...
                    if(dataGeneralCriterio17.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio17.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio17.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio17.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio17.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio17.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio17(' + dataGeneralCriterio17.year + ', ' + dataGeneralCriterio17.clave + ', ' + 17 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
