...
<script>
                    ...
                    ok: function(datosGeneralCriterio18){
                        ...
                        for(var i = 0; i < datosGeneralCriterio18.length; i++){
                            ...
                            if(dataGeneralCriterio18.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio18.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio18.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio18.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio18.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio18.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio18(' + dataGeneralCriterio18.year + ', ' + dataGeneralCriterio18.clave + ', ' + 18 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio18){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio18(clave, year, 18);
    ...
    function actualizarDatosGeneralCriterio18(clave, year, criterio){
