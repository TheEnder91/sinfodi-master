...
@include('estimulos.evaluaciones.direcionGeneral.transferencia.modalEvidenciasCriterio18')
...
<script>
    ...
    function verTablaCriterio18(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosGeneralCriterio18){
                // console.log(datosGeneralCriterio18);
                var datosGeneralCriterio18 = datosGeneralCriterio18.response;
                var row = "";
                for(var i = 0; i < datosGeneralCriterio18.length; i++){
                    var dataGeneralCriterio18 = datosGeneralCriterio18[i];
                    // console.log(dataGeneralCriterio18);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-general-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataGeneralCriterio18.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio18.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio18.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio18.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio18.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio18.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio18(' + dataGeneralCriterio18.year + ', ' + dataGeneralCriterio18.clave + ', ' + 18 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
