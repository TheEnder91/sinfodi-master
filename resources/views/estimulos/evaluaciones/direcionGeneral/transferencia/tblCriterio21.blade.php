...
@include('estimulos.evaluaciones.direcionGeneral.transferencia.modalEvidenciasCriterio21')
...
<script>
    ...
    function verTablaCriterio21(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosGeneralCriterio21){
                // console.log(datosGeneralCriterio21);
                var datosGeneralCriterio21 = datosGeneralCriterio21.response;
                var row = "";
                for(var i = 0; i < datosGeneralCriterio21.length; i++){
                    var dataGeneralCriterio21 = datosGeneralCriterio21[i];
                    // console.log(dataGeneralCriterio21);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-general-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataGeneralCriterio21.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio21.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio21.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio21.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio21.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio21.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio21(' + dataGeneralCriterio21.year + ', ' + dataGeneralCriterio21.clave + ', ' + 21 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
