...
<script>
                    ...
                    ok: function(datosGeneralCriterio21){
                        ...
                        for(var i = 0; i < datosGeneralCriterio21.length; i++){
                            ...
                            if(dataGeneralCriterio21.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio21.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio21.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio21.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio21.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio21.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio21(' + dataGeneralCriterio21.year + ', ' + dataGeneralCriterio21.clave + ', ' + 21 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio21){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio21(clave, year, 21);
    ...
    function actualizarDatosGeneralCriterio21(clave, year, criterio){
