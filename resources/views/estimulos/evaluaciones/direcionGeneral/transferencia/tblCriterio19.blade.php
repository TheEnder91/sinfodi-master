...
<script>
                    ...
                    ok: function(datosGeneralCriterio19){
                        ...
                        for(var i = 0; i < datosGeneralCriterio19.length; i++){
                            ...
                            if(dataGeneralCriterio19.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio19.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio19.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio19.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio19.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio19.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio19(' + dataGeneralCriterio19.year + ', ' + dataGeneralCriterio19.clave + ', ' + 19 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio19){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosGeneralCriterio19(clave, year, 19);
    ...
    function actualizarDatosGeneralCriterio19(clave, year, criterio){
