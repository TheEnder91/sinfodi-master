            ...
            ok: function(datosGeneralCriterio16){
                ...
                for(var i = 0; i < datosGeneralCriterio16.length; i++){
                    ...
                    if(dataGeneralCriterio16.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio16.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio16.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio16.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio16.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio16.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio16(' + dataGeneralCriterio16.year + ', ' + dataGeneralCriterio16.clave + ', ' + 16 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
