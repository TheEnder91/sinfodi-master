...
@include('estimulos.evaluaciones.direcionGeneral.acreditaciones.modalEvidenciasCriterio35')
            ...
            ok: function(datosCritero35){
                ...
                if(datosCriterio35.length > 0){
                    ...
                    for(var i = 0; i < datosCriterio35.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionGeneral/posgrado/searchUsernamePosgrado/" + dataCriterio35.numero_personal,
                            type: 'GET',
                            dataType: 'json',
