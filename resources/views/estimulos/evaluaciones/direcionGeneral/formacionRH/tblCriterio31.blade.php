                    ...
                    ok: function(datosGeneralCriterio31){
                        ...
                        for(var i = 0; i < datosGeneralCriterio31.length; i++){
                            ...
                            if(dataGeneralCriterio31.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataGeneralCriterio31.clave + '</td>';
                                row += '<td width="40%">' + dataGeneralCriterio31.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio31.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio31.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataGeneralCriterio31.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio31(' + dataGeneralCriterio31.year + ', ' + dataGeneralCriterio31.clave + ', ' + 31 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
