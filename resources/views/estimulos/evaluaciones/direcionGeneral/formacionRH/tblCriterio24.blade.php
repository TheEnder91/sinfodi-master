            ...
            ok: function(datosGeneralCriterio24){
                ...
                for(var i = 0; i < datosGeneralCriterio24.length; i++){
                    ...
                    if(dataGeneralCriterio24.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio24.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataGeneralCriterio24.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio24.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataGeneralCriterio24.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataGeneralCriterio24.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio24(' + dataGeneralCriterio24.year + ', ' + dataGeneralCriterio24.clave + ', ' + 24 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
