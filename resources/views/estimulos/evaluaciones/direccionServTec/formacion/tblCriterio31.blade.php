...
@include('estimulos.evaluaciones.direccionServTec.formacion.modalEvidenciasCriterio31')
            ...
            ok: function(datosCritero31){
                ...
                if(datosCriterio31.length > 0){
                    for(var i = 0; i < datosCriterio31.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/formacionRH/searchUsernameFormacionRH/" + dataCriterio31.numero_personal,
                            type: 'GET',
                            dataType: 'json',
