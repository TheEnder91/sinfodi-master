...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Evaluacion a la dirección de servicios tecnologicos->Difusión y Divulgación</li>
    </ol>
@endsection

@section('content')
    @component('components.card')
        @slot('title_card', 'Evaluación a la dirección de servicios tecnologicos->Difusión y Divulgación')
        <div class="row">
            <div class="col-3">
            ...
            <table id="tblCriterio1" class="table table-bordered table-striped">
                ...
                <thead>
                    <tr class="text-center">
                        ...
                        @if (Auth::user()->hasPermissionTo("estimulo-evaluaciones-servicios-difusiondivulgacion-index"))
        ...
        @include('estimulos.evaluaciones.direccionServTec.difusionDivulgacion.modalEvidenciasCriterio1')
    @endcomponent
@endsection
...
<script>
    ...
    function obtenerCriterio1(year){
        ...
        // Codigo de prueba...
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/searchDifDIv/" + año,
            type: 'GET',
            dataType: 'json',
    ...
    function verTablaCriterio1(año, criterio){
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/datosDifDiv/" + año + "/" + criterio,
            type: 'GET',
            dataType: 'json',
            ok: function(datosGeneralCriterio1){
                ...
                for(var i = 0; i < datosGeneralCriterio1.length; i++){
                    ...
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-servicios-difusiondivulgacion-index") ?>';
    ...
    function verEvidenciasCriterio1(year, clave){
        ...
        consultarDatos({
            ...
            ok: function(dataEvidenciasCriterio1){
                ...
                consultarDatos({
                    action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/puntosDifDiv/" + criterio + "/" + objetivo,
                    type: 'GET',
                    dataType: 'json',
                    ok: function(puntosCriterio1){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/getEvidenciasDifDiv/"+clave+"/"+year+"/"+criterio,
                            type: 'GET',
                            dataType: 'json',
    ...
    function actualizarEvidenciasCriterio1(){
        ...
        var objetivo = 1;
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/obtenerEvidenciasDifDiv/" + clave + "/" + year + "/" + criterio,
            type: 'GET',
            dataType: 'json',
                    ...
                    ok: function(puntosCriterio1){
                        ...
                        if(cantidadEvidencias == 0){
                            ...
                            if(existe == 0){
                                $.ajax({
                                    type: 'POST',
                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/savePuntos",
                                    data: {
                                        token: $('#txtTokenRepo').val(),
                                        clave: clave,
                                    ...
                                    success: function(data){
                                        consultarDatos({
                                            ...
                                            ok: function(getEvidenciasCriterio1){
                                                ...
                                                $.ajax({
                                                    type: 'PUT',
                                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/updateDatosPuntos",
                                                    data: {
                                                        token: $('#txtTokenRepo').val(),
                                                        clave: clave,
                                                        id_criterio: criterio,
                                ...
                                $.ajax({
                                    type: 'PUT',
                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionServTec/DifDiv/updateDatosDifDiv",
                                    data: {
                                        token: $('#txtTokenRepo').val(),
                                        clave: clave,
                                        evidencias: serieEvidencias,
