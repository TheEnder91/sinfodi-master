...
@include('estimulos.evaluaciones.direccionCiencia.investigacion.modalEvidenciasCriterio6')
...
<script>
            ...
            ok: function(datosCienciaCriterio6){
                ...
                for(var i = 0; i < datosCienciaCriterio6.length; i++){
                    ...
                    if(dataCienciaCriterio6.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%">' + dataCienciaCriterio6.clave + '</td>';
                        row += '<td width="40%">' + dataCienciaCriterio6.nombre + "</td>";
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio6.puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio6.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio6.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio6(' + dataCienciaCriterio6.year + ', ' + dataCienciaCriterio6.clave + ', ' + 6 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
    ...
    //     var objetivo = 3;
    //     consultarDatos({
    //         action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/investigacion/obtenerEvidenciasInvestigacion/" + clave + "/" + year + "/" + id,
    //         type: 'GET',
    //         dataType: 'json',
    ...
    //                             }
    //                             actualizarDatosCienciaCriterio6(clave, year, 6)
    //                         }else{
    ...
    // function actualizarDatosCienciaCriterio6(clave, year, criterio){
