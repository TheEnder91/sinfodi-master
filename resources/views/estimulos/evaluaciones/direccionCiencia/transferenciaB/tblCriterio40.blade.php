...
<script>
    ...
    function verTablaCriterio40(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosCienciaCriterio40){
                var datosCienciaCriterio40 = datosCienciaCriterio40.response;
                // console.log(datosCienciaCriterio40);
                var row = "";
                for(var i = 0; i < datosCienciaCriterio40.length; i++){
                    var dataCienciaCriteri40 = datosCienciaCriterio40[i];
