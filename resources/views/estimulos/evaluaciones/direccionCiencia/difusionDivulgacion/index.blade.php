...
@section('scripts')
    <script>
            ...
            consultarDatos({
                ...
                ok: function(datosCritero1){
                    ...
                    for(var i = 0; i < datosCriterio1.length; i++){
                        ...
                        var options = {
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/DifDiv/saveDatosDifDiv",
                            json: {
        ...
        function verTablaCriterio1(year, criterio){
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/DifDiv/datosDifDiv/" + year + "/" + criterio,
                type: 'GET',
                dataType: 'json',
