                ...
                ok: function(datosCienciaCriterio14){
                    ...
                    for(var i = 0; i < datosCienciaCriterio14.length; i++){
                        ...
                        if(dataCienciaCriterio14.username == authUser || permissions == 1){
                                ...
                                row += '<td class="text-center" width="5%" style="font-size:12px;"><a href="javascript:verDetalleCriterio14(' + dataCienciaCriterio14.year + ', ' + dataCienciaCriterio14.clave + ')"><i class="fa fa-search"></i></a></td>';
                                row += "</tr>";
                        }
                    }
