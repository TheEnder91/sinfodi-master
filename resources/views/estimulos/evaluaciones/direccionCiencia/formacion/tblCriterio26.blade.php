...
@include('estimulos.evaluaciones.direccionCiencia.formacion.modalEvidenciasCriterio26')
        ...
        consultarDatos({
            ...
            ok: function(datosCritero26){
                ...
                for(var i = 0; i < datosCriterio26.length; i++){
                    ...
                    consultarDatos({
                        action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/formacionRH/searchUsernameFormacionRH/" + dataCriterio26.numero_personal,
                        type: 'GET',
                        dataType: 'json',
            ...
            ok: function(datosCienciaCriterio26){
                ...
                for(var i = 0; i < datosCienciaCriterio26.length; i++){
                    ...
                    if(dataCienciaCriterio26.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%">' + dataCienciaCriterio26.clave + '</td>';
                        row += '<td width="40%">' + dataCienciaCriterio26.nombre + "</td>";
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio26.puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio26.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio26.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio26(' + dataCienciaCriterio26.year + ', ' + dataCienciaCriterio26.clave + ', ' + 26 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
