...
@include('estimulos.evaluaciones.direccionCiencia.formacion.modalEvidenciasCriterio30')
...
<script>
        ...
        consultarDatos({
            ...
            ok: function(datosCritero30){
                ...
                for(var i = 0; i < datosCriterio30.length; i++){
                    ...
                    consultarDatos({
                        action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/formacionRH/searchUsernameFormacionRH/" + dataCriterio30.numero_personal,
                        type: 'GET',
                        dataType: 'json',
    ...
    function verTablaCriterio(year, criterio){
        consultarDatos({
            ...
            ok: function(datosCienciaCriterio30){
                ...
                for(var i = 0; i < datosCienciaCriterio30.length; i++){
                    ...
                    if(dataCienciaCriterio30.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%">' + dataCienciaCriterio30.clave + '</td>';
                        row += '<td width="40%">' + dataCienciaCriterio30.nombre + "</td>";
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio30.puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio30.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio30.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio30(' + dataCienciaCriterio30.year + ', ' + dataCienciaCriterio30.clave + ', ' + 30 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
