<div class="table-responsive">
    <table id="tblCriterio5" class="table table-bordered table-striped" style="font-size:13px;">
        <caption style="font-size:13px;">Alumno del programa de maestría del CIDETEQ graduado entre 43 y 48 meses (Valor del punto: 60).</caption>
        <thead>
...
@include('estimulos.evaluaciones.direccionCiencia.posgrado.modalEvidenciasCriterio5')
...
<script>
            ...
            ok: function(datosCritero5){
                ...
                if(datosCriterio5.length > 0){
                    for(var i = 0; i < datosCriterio5.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/posgrado/searchUsernamePosgrado/" + dataCriterio5.numero_personal,
                            type: 'GET',
                            dataType: 'json',
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                if(year == '2020'){
                                    ...
                                    row += '<img src="{{ asset('img/pdf2.png') }}" style="cursor: pointer" width="60px" height="60px" onClick="mostrarMensajeCriterio5(\''+nuevaFechaInicial+'\',\''+nuevaFechaFinal+'\', '+claveData.meses+', \''+claveData.evidencias+'\');">';
                                    row += '<br>';
                                    row += '<b><input type="checkbox" class="evidenciasCriterio5" name="evidenciasCriterio5[]" id="evidenciasCriterio5'+claveEvidencia+'" value="'+claveData.porcentaje / 100+'" onClick="contarEvidenciasCriterio5(this.checked, '+puntos+', this.value);"> ' + claveEvidencia + '-> ' +claveData.porcentaje+ '%</b>';
                                    row += '</div>';
                                }
                            }
                        }
    ...
    function contarEvidenciasCriterio5(estaChequeado, puntos, porcentaje){
        // Variables...
        var contador = 0;
        ...
        var campo_resultado = document.getElementById('txtTotalCriterio5');
        // Revisamos errores...
        try {
