...
@section('scripts')
    <script>
        ...
        function verTablaCriterio36(){
            ...
            var criterio = 36;
            consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionCiencia/investigacionB/datosInvestigacionB/" + year + "/" + criterio,
            type: 'GET',
            dataType: 'json',
            ok: function(datosCienciaCriterio36){
                var datosCienciaCriterio36 = datosCienciaCriterio36.response;
