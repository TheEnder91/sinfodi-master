...
@include('estimulos.evaluaciones.direccionCiencia.transferencia.modalEvidenciasCriterio16')
...
<script>
    ...
    function verTablaCriterio16(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosCienciaCriterio16){
                // console.log(datosCienciaCriterio16);
                var datosCienciaCriterio16 = datosCienciaCriterio16.response;
                var row = "";
                for(var i = 0; i < datosCienciaCriterio16.length; i++){
                    var dataCienciaCriterio16 = datosCienciaCriterio16[i];
                    // console.log(dataCienciaCriterio16);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-ciencia-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataCienciaCriterio16.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio16.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio16.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio16.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio16.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio16.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio16(' + dataCienciaCriterio16.year + ', ' + dataCienciaCriterio16.clave + ', ' + 16 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
