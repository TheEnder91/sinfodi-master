            ...
            ok: function(datosCienciaCriterio15){
                ...
                for(var i = 0; i < datosCienciaCriterio15.length; i++){
                    ...
                    if(dataCienciaCriterio15.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio15.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio15.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio15.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataCienciaCriterio15.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio15.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio15(' + dataCienciaCriterio15.year + ', ' + dataCienciaCriterio15.clave + ', ' + 15 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
