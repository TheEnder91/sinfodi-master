...
<script>
            ...
            ok: function(datosCienciaCriterio18){
                ...
                for(var i = 0; i < datosCienciaCriterio18.length; i++){
                    ...
                    if(dataCienciaCriterio18.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%">' + dataCienciaCriterio18.clave + '</td>';
                        row += '<td width="40%">' + dataCienciaCriterio18.nombre + "</td>";
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio18.puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio18.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio18.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio18(' + dataCienciaCriterio18.year + ', ' + dataCienciaCriterio18.clave + ', ' + 18 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
    ...
    //                             }
    //                             actualizarDatosCienciaCriterio18(clave, year, 18);
    ...
    // function actualizarDatosCienciaCriterio18(clave, year, criterio){
