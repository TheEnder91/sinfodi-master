            ...
            ok: function(datosCienciaCriterio17){
                ...
                for(var i = 0; i < datosCienciaCriterio17.length; i++){
                    ...
                    if(dataCienciaCriterio17.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio17.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio17.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio17.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio17.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio17.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio17(' + dataCienciaCriterio17.year + ', ' + dataCienciaCriterio17.clave + ', ' + 17 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
