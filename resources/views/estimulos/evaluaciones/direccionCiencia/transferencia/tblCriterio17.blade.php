...
@include('estimulos.evaluaciones.direccionCiencia.transferencia.modalEvidenciasCriterio17')
...
<script>
    ...
    function verTablaCriterio17(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosCienciaCriterio17){
                // console.log(datosCienciaCriterio17);
                var datosCienciaCriterio17 = datosCienciaCriterio17.response;
                var row = "";
                for(var i = 0; i < datosCienciaCriterio17.length; i++){
                    var dataCienciaCriterio17 = datosCienciaCriterio17[i];
                    // console.log(dataCienciaCriterio17);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-ciencia-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataCienciaCriterio17.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%">' + dataCienciaCriterio17.clave + '</td>';
                        row += '<td width="40%">' + dataCienciaCriterio17.nombre + "</td>";
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio17.puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio17.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio17.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio17(' + dataCienciaCriterio17.year + ', ' + dataCienciaCriterio17.clave + ', ' + 17 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
    ...
    //                             }
    //                             actualizarDatosCienciaCriterio17(clave, year, 17);
    ...
    // function actualizarDatosCienciaCriterio17(clave, year, criterio){
