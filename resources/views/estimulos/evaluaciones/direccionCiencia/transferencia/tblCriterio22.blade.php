...
<script>
            ...
            ok: function(datosCienciaCriterio22){
                ...
                for(var i = 0; i < datosCienciaCriterio22.length; i++){
                    ...
                    if(dataCienciaCriterio22.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%">' + dataCienciaCriterio22.clave + '</td>';
                        row += '<td width="40%">' + dataCienciaCriterio22.nombre + "</td>";
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio22.puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio22.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%">' + dataCienciaCriterio22.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio22(' + dataCienciaCriterio22.year + ', ' + dataCienciaCriterio22.clave + ', ' + 22 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
    ...
    //                             }
    //                             actualizarDatosCienciaCriterio22(clave, year, 22);
    ...
    // function actualizarDatosCienciaCriterio22(clave, year, criterio){
