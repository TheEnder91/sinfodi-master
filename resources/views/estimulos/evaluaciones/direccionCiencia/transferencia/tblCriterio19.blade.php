            ...
            ok: function(datosCienciaCriterio19){
                ...
                for(var i = 0; i < datosCienciaCriterio19.length; i++){
                    ...
                    if(dataCienciaCriterio19.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataCienciaCriterio19.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataCienciaCriterio19.nombre + "</td>";
