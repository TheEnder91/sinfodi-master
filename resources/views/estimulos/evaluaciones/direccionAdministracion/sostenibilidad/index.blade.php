...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Evaluaciones a la dirección administración->Sostentabilidad economica</li>
    </ol>
@endsection

@section('content')
    @component('components.card')
        @slot('title_card', 'Evaluación a la dirección administración->Sostentabilidad economica')
        <div class="row">
            <div class="col-3">
...
@section('scripts')
    <script>
        ...
        function obtenerCriterio14(year){
            ...
            var criterio = 14;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostentabilidad/searchSostentabilidad/" + año,
                type: 'GET',
                dataType: 'json',
                ...
                ok: function(datosAdministracionCriterio14){
                    ...
                    for(var i = 0; i < datosAdministracionCriterio14.length; i++){
                        ...
                        if(dataAdministracionCriterio14.username == authUser || permissions == 1){
                                ...
                                row += '<td class="text-center" width="5%" style="font-size:12px;"><a href="javascript:verDetalleCriterio14(' + dataAdministracionCriterio14.year + ', ' + dataAdministracionCriterio14.clave + ')"><i class="fa fa-search"></i></a></td>';
                                row += "</tr>";
                        }
                    }
