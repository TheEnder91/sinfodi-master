...
<script>
                    ...
                    ok: function(datosAdministracionCriterio19){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio19.length; i++){
                            ...
                            if(dataAdministracionCriterio19.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio19.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio19.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio19.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio19.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio19.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio19(' + dataAdministracionCriterio19.year + ', ' + dataAdministracionCriterio19.clave + ', ' + 19 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio19){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio19(clave, year, 19);
    ...
    function actualizarDatosAdministracionCriterio19(clave, year, criterio){
