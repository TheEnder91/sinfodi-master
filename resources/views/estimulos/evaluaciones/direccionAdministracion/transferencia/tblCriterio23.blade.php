...
<script>
                    ...
                    ok: function(datosAdministracionCriterio23){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio23.length; i++){
                            ...
                            if(dataAdministracionCriterio23.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio23.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio23.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio23.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio23.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio23.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio23(' + dataAdministracionCriterio23.year + ', ' + dataAdministracionCriterio23.clave + ', ' + 23 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio23){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio23(clave, year, 23);
    ...
    function actualizarDatosAdministracionCriterio23(clave, year, criterio){
