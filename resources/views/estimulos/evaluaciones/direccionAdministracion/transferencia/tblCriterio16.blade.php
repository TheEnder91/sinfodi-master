...
<script>
                    ...
                    ok: function(datosAdministracionCriterio16){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio16.length; i++){
                            ...
                            if(dataAdministracionCriterio16.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio16.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio16.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio16.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio16.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio16.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio16(' + dataAdministracionCriterio16.year + ', ' + dataAdministracionCriterio16.clave + ', ' + 16 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio16){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio16(clave, year, 16);
    ...
    function actualizarDatosAdministracionCriterio16(clave, year, criterio){
