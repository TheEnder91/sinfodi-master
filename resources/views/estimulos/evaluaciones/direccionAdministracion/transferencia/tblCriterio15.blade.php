...
<script>
                    ...
                    ok: function(datosAdministracionCriterio15){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio15.length; i++){
                            ...
                            if(dataAdministracionCriterio15.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio15.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio15.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio15.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio15.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio15.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio15(' + dataAdministracionCriterio15.year + ', ' + dataAdministracionCriterio15.clave + ', ' + 15 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio15){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio15(clave, year, 15);
    ...
    function actualizarDatosAdministracionCriterio15(clave, year, criterio){
