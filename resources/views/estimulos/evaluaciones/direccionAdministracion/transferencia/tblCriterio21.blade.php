...
<script>
                    ...
                    ok: function(datosAdministracionCriterio21){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio21.length; i++){
                            ...
                            if(dataAdministracionCriterio21.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio21.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio21.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio21.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio21.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio21.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio21(' + dataAdministracionCriterio21.year + ', ' + dataAdministracionCriterio21.clave + ', ' + 21 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio21){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio21(clave, year, 21);
    ...
    function actualizarDatosAdministracionCriterio21(clave, year, criterio){
