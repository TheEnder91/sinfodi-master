...
@include('estimulos.evaluaciones.direccionAdministracion.posgrado.modalEvidenciasCriterio2')
            ...
            ok: function(datosCritero2){
                ...
                if(datosCriterio2.length > 0){
                    for(var i = 0; i < datosCriterio2.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/posgrado/searchUsernamePosgrado/" + dataCriterio2.numero_personal,
                            type: 'GET',
                            dataType: 'json',
