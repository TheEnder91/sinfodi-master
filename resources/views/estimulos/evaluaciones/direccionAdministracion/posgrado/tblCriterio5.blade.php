<div class="table-responsive">
    <table id="tblCriterio5" class="table table-bordered table-striped" style="font-size:13px;">
        <caption>Alumno del programa de maestría del CIDETEQ graduado entre 43 y 48 meses (Valor del punto: 60).</caption>
            ...
            ok: function(datosAdministracionCriterio5){
                ...
                for(var i = 0; i < datosAdministracionCriterio5.length; i++){
                    ...
                    if(dataAdministracionCriterio5.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio5.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataAdministracionCriterio5.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio5.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio5.total_puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio5.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio5(' + dataAdministracionCriterio5.year + ', ' + dataAdministracionCriterio5.clave + ', ' + 5 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
    ...
    function verEvidenciasCriterio5(year, clave, criterio){
        ...
        consultarDatos({
            ...
            ok: function(dataEvidenciasCriterio5){
                ...
                consultarDatos({
                    action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/posgrado/puntosPosgrado/" + criterio + "/" + objetivo,
                    type: 'GET',
                    dataType: 'json',
                    ok: function(puntosCriterio5){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/posgrado/getEvidenciasPosgrado/" + clave + "/" + year + "/" + criterio,
                            type: 'GET',
                            dataType: 'json',
            ...
            ok: function(searchEvidenciasCriterio5){
                ...
                if(cantidadEvidencias == 0){
                    ...
                    if(existe == 0){
                        $.ajax({
                            type: 'POST',
                            url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/posgrado/savePuntos",
                            data: {
                                token: $('#txtTokenRepo').val(),
                                clave: clave,
                            ...
                            success: function(data){
                                ...
                                consultarDatos({
                                    ...
                                    ok: function(getEvidenciasCriterio5){
                                        ...
                                        $.ajax({
                                            type: 'PUT',
                                            url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/posgrado/updateDatosPuntos",
                                            data: {
                                                token: $('#txtTokenRepo').val(),
                                                clave: clave,
                                                id_criterio: criterio,
