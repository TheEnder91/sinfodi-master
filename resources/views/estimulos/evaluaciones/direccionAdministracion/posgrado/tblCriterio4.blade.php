                    ...
                    ok: function(datosAdministracionCriterio4){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio4.length; i++){
                            ...
                            if(dataAdministracionCriterio4.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio4.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio4.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio4.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio4.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio4.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio4(' + dataAdministracionCriterio4.year + ', ' + dataAdministracionCriterio4.clave + ', ' + 4 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
