                    ...
                    ok: function(datosAdministracionCriterio30){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio30.length; i++){
                            ...
                            if(dataAdministracionCriterio30.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio30.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio30.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio30.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio30.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio30.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio30(' + dataAdministracionCriterio30.year + ', ' + dataAdministracionCriterio30.clave + ', ' + 30 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
