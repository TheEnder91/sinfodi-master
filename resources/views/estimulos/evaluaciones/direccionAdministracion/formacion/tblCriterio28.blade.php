                    ...
                    ok: function(datosAdministracionCriterio28){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio28.length; i++){
                            ...
                            if(dataAdministracionCriterio28.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio28.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio28.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio28.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio28.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio28.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio28(' + dataAdministracionCriterio28.year + ', ' + dataAdministracionCriterio28.clave + ', ' + 28 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
