<div class="table-responsive" width = "100%" id="table_refresh">
    <table id="tblCriterio25" class="table table-bordered table-striped" style="font-size:13px;">
        <caption style="font-size:13px;">Atención a alumnos de servicio social concluido (Valor del punto: 3).</caption>
        <thead>
            ...
            ok: function(datosAdministracionCriterio25){
                ...
                for(var i = 0; i < datosAdministracionCriterio25.length; i++){
                    ...
                    if(dataAdministracionCriterio25.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio25.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataAdministracionCriterio25.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio25.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio25.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio25.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio25(' + dataAdministracionCriterio25.year + ', ' + dataAdministracionCriterio25.clave + ', ' + 25 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
                    ...
                    ok: function(puntosCriterio25){
                        ...
                        for(var i = 0; i < datos.length; i++){
                            ...
                            if(claveData.evidencias != null){
                                ...
                                row += '<br>';
                                row += '<b><input type="checkbox" class="evidenciasCriterio25" name="evidenciasCriterio25[]" id="evidenciasCriterio25'+claveEvidencias+'" value="'+claveEvidencias+'" onClick="contarEvidenciasCriterio25('+puntos+');"> ' + claveEvidencias + ' -> ' + claveData.porcentaje + '%</b>';
                                row += '</div>';
                            }
                        }
