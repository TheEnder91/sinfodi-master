...
@include('estimulos.evaluaciones.direccionAdministracion.investigacion.modalEvidenciasCriterio8')
...
<script>
    ...
    function verTablaCriterio8(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosAdministracionCriterio8){
                // console.log(datosAdministracionCriterio8);
                var datosAdministracionCriterio8 = datosAdministracionCriterio8.response;
                var row = "";
                for(var i = 0; i < datosAdministracionCriterio8.length; i++){
                    var dataAdministracionCriterio8 = datosAdministracionCriterio8[i];
                    // console.log(dataAdministracionCriterio8);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-administracion-investigacion-index") ?>';
                    // console.log(permissions);
                    if(dataAdministracionCriterio8.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio8.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataAdministracionCriterio8.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio8.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio8.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio8.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio8(' + dataAdministracionCriterio8.year + ', ' + dataAdministracionCriterio8.clave + ', ' + 8 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
                        ...
                        consultarDatos({
                            ...
                            ok: function(getEvidenciasCriterio8){
                                ...
                                if(array.length > 0){
                                    ...
                                    $('#txtCantidadCriterio8').val(dataEvidencias.puntos);
                                    $('#txtTotalCriterio8').val(dataEvidencias.total_puntos);
                                }
                            },
                        });
                    },
