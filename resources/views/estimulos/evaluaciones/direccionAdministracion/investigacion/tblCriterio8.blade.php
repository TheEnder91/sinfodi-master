...
<script>
                    ...
                    ok: function(datosAdministracionCriterio8){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio8.length; i++){
                            ...
                            if(dataAdministracionCriterio8.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio8.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio8.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio8.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio8.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio8.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio8(' + dataAdministracionCriterio8.year + ', ' + dataAdministracionCriterio8.clave + ', ' + 8 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio8){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio8(clave, year, 8)
                            }else{
    ...
    function actualizarDatosAdministracionCriterio8(clave, year, criterio){
