...
<script>
                    ...
                    ok: function(datosAdministracionCriterio13){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio13.length; i++){
                            ...
                            if(dataAdministracionCriterio13.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio13.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio13.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio13.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio13.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio13.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio13(' + dataAdministracionCriterio13.year + ', ' + dataAdministracionCriterio13.clave + ', ' + 13 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio13){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio13(clave, year, 13);
                            }else{
    ...
    function actualizarDatosAdministracionCriterio13(clave, year, criterio){
