...
@include('estimulos.evaluaciones.direccionAdministracion.investigacion.modalEvidenciasCriterio13')
...
<script>
    ...
    function verTablaCriterio13(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosAdministracionCriterio13){
                // console.log(datosAdministracionCriterio13);
                var datosAdministracionCriterio13 = datosAdministracionCriterio13.response;
                var row = "";
                for(var i = 0; i < datosAdministracionCriterio13.length; i++){
                    var dataAdministracionCriterio13 = datosAdministracionCriterio13[i];
                    // console.log(dataAdministracionCriterio13);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-administracion-investigacion-index") ?>';
                    // console.log(permissions);
                    if(dataAdministracionCriterio13.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio13.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataAdministracionCriterio13.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio13.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio13.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio13.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio13(' + dataAdministracionCriterio13.year + ', ' + dataAdministracionCriterio13.clave + ', ' + 13 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
