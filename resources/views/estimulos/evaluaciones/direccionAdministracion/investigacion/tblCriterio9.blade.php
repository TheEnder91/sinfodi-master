                    ...
                    ok: function(datosAdministracionCriterio9){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio9.length; i++){
                            ...
                            if(dataAdministracionCriterio9.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio9.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio9.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio9.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio9.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio9.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio9(' + dataAdministracionCriterio9.year + ', ' + dataAdministracionCriterio9.clave + ', ' + 9 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio9){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio9(clave, year, 9);
                            }else{
