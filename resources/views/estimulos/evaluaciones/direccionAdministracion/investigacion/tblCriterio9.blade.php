...
@include('estimulos.evaluaciones.direccionAdministracion.investigacion.modalEvidenciasCriterio9')
...
<script>
    ...
    function verTablaCriterio9(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosAdministracionCriterio9){
                // console.log(datosAdministracionCriterio9);
                var datosAdministracionCriterio9 = datosAdministracionCriterio9.response;
                var row = "";
                for(var i = 0; i < datosAdministracionCriterio9.length; i++){
                    var dataAdministracionCriterio9 = datosAdministracionCriterio9[i];
                    // console.log(dataAdministracionCriterio9);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-administracion-investigacion-index") ?>';
                    // console.log(permissions);
                    if(dataAdministracionCriterio9.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio9.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataAdministracionCriterio9.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio9.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio9.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio9.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio9(' + dataAdministracionCriterio9.year + ', ' + dataAdministracionCriterio9.clave + ', ' + 9 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
