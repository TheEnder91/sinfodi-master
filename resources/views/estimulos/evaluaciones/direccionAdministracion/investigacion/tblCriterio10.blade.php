...
<script>
                    ...
                    ok: function(datosAdministracionCriterio10){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio10.length; i++){
                            ...
                            if(dataAdministracionCriterio10.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio10.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio10.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio10.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio10.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio10.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio10(' + dataAdministracionCriterio10.year + ', ' + dataAdministracionCriterio10.clave + ', ' + 10 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio10){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio10(clave, year, 10);
                            }else{
    ...
    function actualizarDatosAdministracionCriterio10(clave, year, criterio){
