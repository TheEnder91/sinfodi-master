...
@include('estimulos.evaluaciones.direccionAdministracion.investigacion.modalEvidenciasCriterio10')
...
<script>
    ...
    function verTablaCriterio10(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosAdministracionCriterio10){
                // console.log(datosAdministracionCriterio10);
                var datosAdministracionCriterio10 = datosAdministracionCriterio10.response;
                var row = "";
                for(var i = 0; i < datosAdministracionCriterio10.length; i++){
                    var dataAdministracionCriterio10 = datosAdministracionCriterio10[i];
                    // console.log(dataAdministracionCriterio10);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-administracion-investigacion-index") ?>';
                    // console.log(permissions);
                    if(dataAdministracionCriterio10.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio10.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataAdministracionCriterio10.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio10.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataAdministracionCriterio10.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataAdministracionCriterio10.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio10(' + dataAdministracionCriterio10.year + ', ' + dataAdministracionCriterio10.clave + ', ' + 10 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
                        ...
                        consultarDatos({
                            ...
                            ok: function(getEvidenciasCriterio10){
                                ...
                                if(array.length > 0){
                                    ...
                                    $('#txtCantidadCriterio10').val(dataEvidencias.puntos);
                                    $('#txtTotalCriterio10').val(dataEvidencias.total_puntos);
                                }
                            },
                        });
                    },
