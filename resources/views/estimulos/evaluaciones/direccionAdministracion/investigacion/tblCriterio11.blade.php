...
<script>
                    ...
                    ok: function(datosAdministracionCriterio11){
                        ...
                        for(var i = 0; i < datosAdministracionCriterio11.length; i++){
                            ...
                            if(dataAdministracionCriterio11.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataAdministracionCriterio11.clave + '</td>';
                                row += '<td width="40%">' + dataAdministracionCriterio11.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio11.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio11.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataAdministracionCriterio11.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio11(' + dataAdministracionCriterio11.year + ', ' + dataAdministracionCriterio11.clave + ', ' + 11 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio11){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosAdministracionCriterio11(clave, year, 11);
                            }else{
    ...
    function actualizarDatosAdministracionCriterio11(clave, year, criterio){
