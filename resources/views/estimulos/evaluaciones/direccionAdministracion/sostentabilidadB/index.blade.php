...
@section('scripts')
    <script>
        ...
        function obtenerCriterio37(year){
            ...
            var criterio = 37;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostenibilidadB/searchSostenibilidadB/" + año,
                type: 'GET',
                dataType: 'json',
                ok: function(datosCritero37){
                    ...
                    if(datosCriterio37.length > 0){
                        ...
                        // console.log(arr2);
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostenibilidadB/puntos/" + criterio + "/" + id_objetivo,
                            type: 'GET',
                            dataType: 'json',
        ...
        function verTablaCriterio37(year, criterio){
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostenibilidadB/datosSostenibilidadB/" + year + "/" + criterio,
                type: 'GET',
                dataType: 'json',
                ok: function(datosGeneralCriterio37){
                    ...
                    for(var i = 0; i < datosGeneralCriterio37.length; i++){
                        ...
                        var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-administracion-sostentabilidadB-index") ?>';
        ...
        function verDetalleCriterio37(year, clave){
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/sostenibilidadB/getDatosRemanente/" + clave + "/" + year,
                type: 'GET',
                dataType: 'json',
