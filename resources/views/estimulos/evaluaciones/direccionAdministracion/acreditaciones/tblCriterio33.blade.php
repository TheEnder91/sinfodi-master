...
@include('estimulos.evaluaciones.direccionAdministracion.acreditaciones.modalEvidenciasCriterio33')
<script>
            ...
            ok: function(datosCritero33 ){
                ...
                if(datosCriterio33.length > 0){
                    ...
                    for(var i = 0; i < datosCriterio33.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/posgrado/searchUsernamePosgrado/" + dataCriterio33.numero_personal,
                            type: 'GET',
                            dataType: 'json',
