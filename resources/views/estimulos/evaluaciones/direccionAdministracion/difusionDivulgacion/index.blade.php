    ...
    @component('components.card')
        ...
        <div class="table-responsive">
            <table id="tblCriterio1" class="table table-bordered table-striped">
                <caption style="font-size:13px;">Listado de evaluación Dirección de administración->Difusión y Divulgación (Valor del punto: 10).</caption>
                <thead>
...
<script>
        ...
        consultarDatos({
            ...
            ok: function(datosCritero1){
                ...
                for(var i = 0; i < datosCriterio1.length; i++){
                    ...
                    // $.ajax({
                    //     type: 'POST',
                    //     url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/saveDatosDifDiv",
                    //     data: {
    ...
    function verTablaCriterio1(año, criterio){
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/datosDifDiv/" + año + "/" + criterio,
            type: 'GET',
            dataType: 'json',
    ...
    function verEvidenciasCriterio1(year, clave){
        ...
        $('#txtTotal').val(0);
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/searchEvidenciasDifDiv/" + year + "/" + clave,
            type: 'GET',
            dataType: 'json',
            ok: function(dataEvidenciasCriterio1){
                $('#modalEvidenciasCriterio1').modal({backdrop: 'static', keyboard: false});
                consultarDatos({
                    action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/puntosDifDiv/" + criterio + "/" + objetivo,
                    type: 'GET',
                    dataType: 'json',
                    ok: function(puntosCriterio1){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/getEvidenciasDifDiv/" + clave + "/" + year + "/" + criterio,
                            type: 'GET',
                            dataType: 'json',
    ...
    function actualizarEvidenciasCriterio1(){
        ...
        var objetivo = 1;
        consultarDatos({
            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/obtenerEvidenciasDifDiv/" + clave + "/" + year + "/" + criterio,
            type: 'GET',
            dataType: 'json',
                    ...
                    ok: function(puntosCriterio1){
                        ...
                        if(cantidadEvidencias == 0){
                            ...
                            if(existe == 0){
                                $.ajax({
                                    type: 'POST',
                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/savePuntos",
                                    data: {
                                        token: $('#txtTokenRepo').val(),
                                        clave: clave,
                                    ...
                                    success: function(data){
                                        consultarDatos({
                                            ...
                                            ok: function(getEvidenciasCriterio1){
                                                ...
                                                $.ajax({
                                                    type: 'PUT',
                                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/updateDatosPuntos",
                                                    data: {
                                                        token: $('#txtTokenRepo').val(),
                                                        clave: clave,
                                                        id_criterio: criterio,
                                ...
                                $.ajax({
                                    type: 'PUT',
                                    url: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionAdministracion/DifDiv/updateDatosDifDiv",
                                    data: {
                                        token: $('#txtTokenRepo').val(),
                                        clave: clave,
                                        evidencias: serieEvidencias,
