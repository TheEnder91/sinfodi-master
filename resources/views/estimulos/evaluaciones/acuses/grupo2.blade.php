    ...
    <fieldset>
        ...
        <div style="width: 100%; text-align: center;">
            <table class="factores">
                ...
                <tbody>
                    <tr>
                        <td class="tbody" style="text-align: center;">1.5</td>
                        <td class="tbody" style="text-align: center">Alto</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="tbody" style="text-align: center;">0.5</td>
                        <td class="tbody" style="text-align: center">Bajo</td>
                    </tr>
                    <tr>
                        <td class="tbody" style="text-align: center;">0</td>
                        <td class="tbody" style="text-align: center">Nulo</td>
                    </tr>
                </tbody>
            </table>
        </div>
