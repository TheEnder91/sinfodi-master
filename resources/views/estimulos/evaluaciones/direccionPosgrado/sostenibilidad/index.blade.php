...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Evaluaciones a la dirección posgrado->Sostentabilidad economica</li>
    </ol>
@endsection

@section('content')
    @component('components.card')
        @slot('title_card', 'Evaluación a la dirección posgrado->Sostentabilidad economica')
        <div class="row">
            <div class="col-3">
        ...
        function obtenerCriterio14(year){
            ...
            consultarDatos({
                ...
                ok: function(datosCritero14){
                    ...
                    consultarDatos({
                        action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/sostentabilidad/datosSostentabilidad/" + año + "/" + criterio,
                        type: 'GET',
                        dataType: 'json',
