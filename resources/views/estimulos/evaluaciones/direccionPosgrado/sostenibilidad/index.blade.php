...
@section('scripts')
    <script>
                ...
                ok: function(datosPosgradoCriterio14){
                    ...
                    for(var i = 0; i < datosPosgradoCriterio14.length; i++){
                        ...
                        if(dataPosgradoCriterio14.username == authUser || permissions == 1){
                                ...
                                row += '<td class="text-center" width="5%" style="font-size:12px;"><a href="javascript:verDetalleCriterio14(' + dataPosgradoCriterio14.year + ', ' + dataPosgradoCriterio14.clave + ')"><i class="fa fa-search"></i></a></td>';
                                row += "</tr>";
                        }
                    }
        ...
        function verDetalleCriterio14(year, clave){
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/sostentabilidad/calculosSostentabilidad/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/sostentabilidad/detallesProyectos/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
            ...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/sostentabilidad/detallesServicios/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
            ...
            // Detalles cursos...
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/sostentabilidad/detallesCursos/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
