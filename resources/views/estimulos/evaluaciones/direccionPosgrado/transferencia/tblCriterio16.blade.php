...
<script>
                    ...
                    ok: function(datosPosgradoCriterio16){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio16.length; i++){
                            ...
                            if(dataPosgradoCriterio16.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio16.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio16.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio16.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio16.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio16.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio16(' + dataPosgradoCriterio16.year + ', ' + dataPosgradoCriterio16.clave + ', ' + 16 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio16){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio16(clave, year, 16);
    ...
    function actualizarDatosPosgradoCriterio16(clave, year, criterio){
