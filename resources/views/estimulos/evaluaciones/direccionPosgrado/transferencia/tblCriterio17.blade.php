...
<script>
                    ...
                    ok: function(datosPosgradoCriterio17){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio17.length; i++){
                            ...
                            if(dataPosgradoCriterio17.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio17.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio17.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio17.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio17.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio17.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio17(' + dataPosgradoCriterio17.year + ', ' + dataPosgradoCriterio17.clave + ', ' + 17 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio17){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio17(clave, year, 17);
    ...
    function actualizarDatosPosgradoCriterio17(clave, year, criterio){
