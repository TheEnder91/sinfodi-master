...
@include('estimulos.evaluaciones.direccionPosgrado.transferencia.modalEvidenciasCriterio17')
...
<script>
    ...
    function verTablaCriterio17(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosPosgradoCriterio17){
                // console.log(datosPosgradoCriterio17);
                var datosPosgradoCriterio17 = datosPosgradoCriterio17.response;
                var row = "";
                for(var i = 0; i < datosPosgradoCriterio17.length; i++){
                    var dataPosgradoCriterio17 = datosPosgradoCriterio17[i];
                    // console.log(dataPosgradoCriterio17);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-posgrado-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataPosgradoCriterio17.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio17.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio17.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio17.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio17.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio17.year + '</td>';
                        if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio17(' + dataPosgradoCriterio17.year + ', ' + dataPosgradoCriterio17.clave + ', ' + 17 +')"><i class="fa fa-edit"></i></a></td>';
                        }
                        row += "</tr>";
                    }
                }
