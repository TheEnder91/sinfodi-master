...
<script>
                    ...
                    ok: function(datosPosgradoCriterio23){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio23.length; i++){
                            ...
                            if(dataPosgradoCriterio23.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio23.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio23.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio23.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio23.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio23.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio23(' + dataPosgradoCriterio23.year + ', ' + dataPosgradoCriterio23.clave + ', ' + 23 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio23){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio23(clave, year, 23);
    ...
    function actualizarDatosPosgradoCriterio23(clave, year, criterio){
