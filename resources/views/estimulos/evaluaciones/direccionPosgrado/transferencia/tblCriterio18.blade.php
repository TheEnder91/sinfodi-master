...
<script>
                    ...
                    ok: function(datosPosgradoCriterio18){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio18.length; i++){
                            ...
                            if(dataPosgradoCriterio18.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio18.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio18.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio18.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio18.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio18.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio18(' + dataPosgradoCriterio18.year + ', ' + dataPosgradoCriterio18.clave + ', ' + 18 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio18){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio18(clave, year, 18);
    ...
    function actualizarDatosPosgradoCriterio18(clave, year, criterio){
