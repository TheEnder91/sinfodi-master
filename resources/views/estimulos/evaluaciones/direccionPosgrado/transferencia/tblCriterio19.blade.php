...
<script>
                    ...
                    ok: function(datosPosgradoCriterio19){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio19.length; i++){
                            ...
                            if(dataPosgradoCriterio19.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio19.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio19.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio19.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio19.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio19.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio19(' + dataPosgradoCriterio19.year + ', ' + dataPosgradoCriterio19.clave + ', ' + 19 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio19){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio19(clave, year, 19);
    ...
    function actualizarDatosPosgradoCriterio19(clave, year, criterio){
