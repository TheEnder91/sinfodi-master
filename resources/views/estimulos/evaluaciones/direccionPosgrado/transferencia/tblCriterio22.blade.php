...
<script>
                    ...
                    ok: function(datosPosgradoCriterio22){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio22.length; i++){
                            ...
                            if(dataPosgradoCriterio22.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio22.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio22.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio22.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio22.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio22.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio22(' + dataPosgradoCriterio22.year + ', ' + dataPosgradoCriterio22.clave + ', ' + 22 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio22){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio22(clave, year, 22);
    ...
    function actualizarDatosPosgradoCriterio22(clave, year, criterio){
