...
@include('estimulos.evaluaciones.direccionPosgrado.transferencia.modalEvidenciasCriterio22')
...
<script>
    ...
    function verTablaCriterio22(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosPosgradoCriterio22){
                // console.log(datosPosgradoCriterio22);
                var datosPosgradoCriterio22 = datosPosgradoCriterio22.response;
                var row = "";
                for(var i = 0; i < datosPosgradoCriterio22.length; i++){
                    var dataPosgradoCriterio22 = datosPosgradoCriterio22[i];
                    // console.log(dataPosgradoCriterio22);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-posgrado-transferencia-index") ?>';
                    // console.log(permissions);
                    if(dataPosgradoCriterio22.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio22.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio22.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio22.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio22.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio22.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio22(' + dataPosgradoCriterio22.year + ', ' + dataPosgradoCriterio22.clave + ', ' + 22 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
