            ...
            ok: function(datosPosgradoCriterio20){
                ...
                for(var i = 0; i < datosPosgradoCriterio20.length; i++){
                    ...
                    if(dataPosgradoCriterio20.username == authUser || permissions == 1){
                        ...
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio20.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio20.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio20.total_puntos) + '</td>';
