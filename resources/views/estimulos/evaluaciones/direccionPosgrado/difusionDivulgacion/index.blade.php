...
@section('scripts')
    <script>
        ...
        function verTablaCriterio1(year, criterio){
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/DifDiv/datosDifDiv/" + year + "/" + criterio,
                type: 'GET',
                dataType: 'json',
                ok: function(datosGeneralCriterio1){
                    ...
                    for(var i = 0; i < datosGeneralCriterio1.length; i++){
                       ...
                       var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-posgrado-difusiondivulgacion-index") ?>';
