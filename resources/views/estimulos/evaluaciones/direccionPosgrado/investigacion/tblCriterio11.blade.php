...
@include('estimulos.evaluaciones.direccionPosgrado.investigacion.modalEvidenciasCriterio11')
...
<script>
    ...
    function verTablaCriterio11(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosPosgradoCriterio11){
                // console.log(datosPosgradoCriterio11);
                var datosPosgradoCriterio11 = datosPosgradoCriterio11.response;
                var row = "";
                for(var i = 0; i < datosPosgradoCriterio11.length; i++){
                    var dataPosgradoCriterio11 = datosPosgradoCriterio11[i];
                    // console.log(dataPosgradoCriterio11);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-posgrado-investigacion-index") ?>';
                    // console.log(permissions);
                    if(dataPosgradoCriterio11.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio11.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio11.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio11.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio11.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio11.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio11(' + dataPosgradoCriterio11.year + ', ' + dataPosgradoCriterio11.clave + ', ' + 11 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
