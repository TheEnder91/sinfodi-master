...
<script>
                    ...
                    ok: function(datosPosgradoCriterio11){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio11.length; i++){
                            ...
                            if(dataPosgradoCriterio11.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio11.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio11.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio11.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio11.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio11.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio11(' + dataPosgradoCriterio11.year + ', ' + dataPosgradoCriterio11.clave + ', ' + 11 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio11){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio11(clave, year, 11);
                            }else{
    ...
    function actualizarDatosPosgradoCriterio11(clave, year, criterio){
