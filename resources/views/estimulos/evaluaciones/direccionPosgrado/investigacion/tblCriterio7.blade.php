...
<script>
                    ...
                    ok: function(datosPosgradoCriterio7){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio7.length; i++){
                            ...
                            if(dataPosgradoCriterio7.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio7.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio7.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio7.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio7.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio7.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio7(' + dataPosgradoCriterio7.year + ', ' + dataPosgradoCriterio7.clave + ', ' + 7 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio7){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio7(clave, year, 7)
                            }else{
    ...
    function actualizarDatosPosgradoCriterio7(clave, year, criterio){
