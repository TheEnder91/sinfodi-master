...
<script>
                    ...
                    ok: function(datosPosgradoCriterio10){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio10.length; i++){
                            ...
                            if(dataPosgradoCriterio10.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio10.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio10.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio10.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio10.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio10.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio10(' + dataPosgradoCriterio10.year + ', ' + dataPosgradoCriterio10.clave + ', ' + 10 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
                    ...
                    ok: function(puntosCriterio10){
                        ...
                        if(puntos == 0){
                            ...
                            if(existe == 0){
                                ...
                                actualizarDatosPosgradoCriterio10(clave, year, 10);
                            }else{
    ...
    function actualizarDatosPosgradoCriterio10(clave, year, criterio){
