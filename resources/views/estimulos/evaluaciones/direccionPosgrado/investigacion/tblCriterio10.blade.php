...
@include('estimulos.evaluaciones.direccionPosgrado.investigacion.modalEvidenciasCriterio10')
...
<script>
    ...
    function verTablaCriterio10(year, criterio){
        consultarDatos({
            ...
            type: 'GET',
            dataType: 'json',
            ok: function(datosPosgradoCriterio10){
                // console.log(datosPosgradoCriterio10);
                var datosPosgradoCriterio10 = datosPosgradoCriterio10.response;
                var row = "";
                for(var i = 0; i < datosPosgradoCriterio10.length; i++){
                    var dataPosgradoCriterio10 = datosPosgradoCriterio10[i];
                    // console.log(dataPosgradoCriterio10);
                    var authUser = '<?= Auth::user()->usuario ?>';
                    var permissions = '<?= Auth::user()->hasPermissionTo("estimulo-evaluaciones-posgrado-investigacion-index") ?>';
                    // console.log(permissions);
                    if(dataPosgradoCriterio10.username == authUser || permissions == 1){
                        row += "<tr>";
                        row += '<th scope="row" class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio10.clave + '</td>';
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio10.nombre.toUpperCase() + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio10.puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + parseInt(dataPosgradoCriterio10.total_puntos) + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio10.year + '</td>';
                        // if(permissions == 1){
                            row += '<td class="text-center" width="10%" style="font-size:12px;"><a href="javascript:verEvidenciasCriterio10(' + dataPosgradoCriterio10.year + ', ' + dataPosgradoCriterio10.clave + ', ' + 10 +')"><i class="fa fa-edit"></i></a></td>';
                        // }
                        row += "</tr>";
                    }
                }
