                    ...
                    ok: function(datosPosgradoCriterio25){
                        ...
                        for(var i = 0; i < datosPosgradoCriterio25.length; i++){
                            ...
                            if(dataPosgradoCriterio25.username == authUser || permissions == 1){
                                row += "<tr>";
                                row += '<th scope="row" class="text-center" width="10%">' + dataPosgradoCriterio25.clave + '</td>';
                                row += '<td width="40%">' + dataPosgradoCriterio25.nombre + "</td>";
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio25.puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio25.total_puntos + '</td>';
                                row += '<td class="text-center" width="10%">' + dataPosgradoCriterio25.year + '</td>';
                                if(permissions == 1){
                                    row += '<td class="text-center" width="10%"><a href="javascript:verEvidenciasCriterio25(' + dataPosgradoCriterio25.year + ', ' + dataPosgradoCriterio25.clave + ', ' + 25 +')"><i class="fa fa-edit"></i></a></td>';
                                }
                                row += "</tr>";
                            }
                        }
