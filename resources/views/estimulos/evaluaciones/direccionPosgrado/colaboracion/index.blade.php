...
@section('scripts')
    <script>
                ...
                ok: function(datosPosgradoCriterio32){
                    ...
                    for(var i = 0; i < datosPosgradoCriterio32.length; i++){
                        ...
                        if(dataPosgradoCriterio32.username == authUser || permissions == 1){
                                ...
                                row += '<td class="text-center" width="5%" style="font-size:12px;"><a href="javascript:verDetalleCriterio32(' + dataPosgradoCriterio32.year + ', ' + dataPosgradoCriterio32.clave + ')"><i class="fa fa-search"></i></a></td>';
                                row += "</tr>";
                        }
                    }
        ...
        function verDetalleCriterio32(year, clave){
            ...
            var puntos = 10;
            consultarDatos({
                action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/colaboracion/getComiteColaboracion/" + year + "/" + clave,
                type: 'GET',
                dataType: 'json',
