            ...
            ok: function(datosPosgradoCriterio4){
                ...
                for(var i = 0; i < datosPosgradoCriterio4.length; i++){
                    ...
                    if(dataPosgradoCriterio4.username == authUser || permissions == 1){
                        ...
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio4.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio4.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio4.total_puntos + '</td>';
