...
@include('estimulos.evaluaciones.direccionPosgrado.posgrado.modalEvidenciasCriterio4')
            ...
            ok: function(datosCritero4){
                ...
                if(datosCriterio4.length > 0){
                    for(var i = 0; i < datosCriterio4.length; i++){
                        ...
                        consultarDatos({
                            action: "{{ config('app.url') }}/estimulos/evaluaciones/DireccionPosgrado/posgrado/searchUsernamePosgrado/" + dataCriterio4.numero_personal,
                            type: 'GET',
                            dataType: 'json',
