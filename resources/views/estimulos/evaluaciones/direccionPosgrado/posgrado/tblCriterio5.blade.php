            ...
            ok: function(datosPosgradoCriterio5){
                ...
                for(var i = 0; i < datosPosgradoCriterio5.length; i++){
                    ...
                    if(dataPosgradoCriterio5.username == authUser || permissions == 1){
                        ...
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio5.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio5.puntos + '</td>';
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio5.total_puntos + '</td>';
