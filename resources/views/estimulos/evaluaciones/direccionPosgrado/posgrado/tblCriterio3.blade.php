            ...
            ok: function(datosPosgradoCriterio3){
                ...
                for(var i = 0; i < datosPosgradoCriterio3.length; i++){
                    ...
                    if(dataPosgradoCriterio3.username == authUser || permissions == 1){
                        ...
                        row += '<td width="40%" style="font-size:12px;">' + dataPosgradoCriterio3.nombre + "</td>";
                        row += '<td class="text-center" width="10%" style="font-size:12px;">' + dataPosgradoCriterio3.puntos + '</td>';
